...
public class Train_ticket_booking_application {
    private static final String train_name = "trivandrum Super Fast Express";
    private static final String train_num = "ECE0710";
    private static final String train_stops[] = {"palakkad","Coimbatore","Erode","Salem","Kanchipuram","Chennai"};
