...
class Atm_application {
    ...
    static void createuser() {
        user[0] = new users("naren", "0512", 31000.00, "sb659", "12345", "uco", "", 0);
        user[1] = new users("akash", "2340", 10000.00, "iob731", "99999", "rbi", "", 0);
        user[2] = new users("aswath", "0909", 60000.00, "can083", "88888", "canara", "", 0);
        user[3] = new users("dinesh", "0808", 20000.00, "tmb023", "77777", "uco", "", 0);
        user[4] = new users("Meghna", "0707", 80000.00, "uco777", "66666", "uco", "", 0);
    }
        ...
        do {
            ...
            switch (ch) {
                case 1:
                    ...
                    System.out.print("\033[H\033[2J");
                    System.out.flush();
                    if (adminId.equals("arun") && pswd.equals("1234")) {
                        int n = 0;
                        do {
